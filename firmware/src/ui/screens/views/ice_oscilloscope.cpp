// Oscilloscope lane D4 RIN view. Centered hero quote with the contract month above and the signed change
...
extern const screen_view_t ice_oscilloscope_view = { build, update };
